...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant.jpg" alt="Alt for image" caption="Pedidos Activos" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-1.jpg" alt="Alt for image" caption="Filtros de Pedidos Activos" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-2.jpg" alt="Alt for image" caption="Cambio de estado de un Pedido" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-3.jpg" alt="Alt for image" caption="Revertir el estado de un Pedido" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-5.jpg" alt="Alt for image" caption="Cancelar un Pedido" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-4.jpg" alt="Alt for image" caption="Opciones de razones para cancelar un Pedido" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-6.jpg" alt="Alt for image" caption="Pedido cancelado"%}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-7.jpg" alt="Alt for image" caption="Retener un Pedido" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-8.jpg" alt="Alt for image" caption="Retener un Pedido" %}
...
{% include image.html img="../docs/primeros-pasos/pedidos-activos-merchant-9.jpg" alt="Alt for image" caption="Liberar un Pedido" %}